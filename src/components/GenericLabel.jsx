...
function GenericLabel ({name, length}) {
    return (
        <div className={`relative w-[45%] h-full flex flex-col justify-evenly items-center`}>
            ...
            <div id='value-track' className={`absolute h-[75%] w-[22%] bottom-0 bg-green z-0 rounded-md border-[0.5px] border-gray`}></div>
            ...
            <div id={`${name.toLowerCase()}-value`} className={`h-[75%] w-full flex flex-col justify-evenly items-center font-font-two text-black text-2xl z-10`}>
                <div id={`${name.toLowerCase()}-prev`} className={`w-8 h-6 bg-green flex justify-center items-center border-black border-b-[1px]`}>{length - 1}</div>
                ...
                <div id={`${name.toLowerCase()}-current`} className={`flex justify-evenly w-2/3`}>
                    ...
                    <div id={`${name.toLowerCase()}-length`} className={`w-8 h-8 font-bold bg-green flex justify-center items-center`}>{length}</div>
                ...
                <div id={`${name.toLowerCase()}-next`} className={`w-8 h-6 bg-green flex justify-center items-center border-black border-t-[1px]`}>{length + 1}</div>
            </div>
        </div>
    );
}
